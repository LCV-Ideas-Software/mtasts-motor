...
- Diretiva vigente de cinco portoes materializada com ESLint real para TypeScript, Biome,
  ...
  toolchain declara Node.js `^22.22.2 || ^24.15.0 || >=26.0.0`, a intersecao dos
  portoes obrigatorios no lockfile, rejeita override markdownlint interno ao checkout e mantem
  `biome.json` sob o gate efetivo do proprio Biome.
